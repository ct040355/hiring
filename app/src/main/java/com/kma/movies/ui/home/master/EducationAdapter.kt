...
class EducationAdapter(val context: Context?, var items: List<Education> = ArrayList()) :
    ...
    fun fillList(items: List<Education>) {
        clear()
        this.items += items
...
class EducationViewHolder(binding: ItemEducationBinding) : RecyclerView.ViewHolder(binding.root) {
