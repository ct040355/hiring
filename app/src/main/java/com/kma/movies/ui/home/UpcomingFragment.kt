...
class UpcomingFragment : Fragment(R.layout.fragment_home), MovieListAdapter.OnItemClickListener {
    ...
    override fun onItemClick(movie: Movie, container: View) {
        val action = UpcomingFragmentDirections.navigateToMovieDetails(id = movie.id.toString(), posterPath = movie.poster_path, isApply = false)
